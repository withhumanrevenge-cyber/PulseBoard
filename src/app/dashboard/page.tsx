    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fdfdfd] text-foreground selection:bg-primary/20">
      <div className="flex flex-col items-center">
        <div className="relative mb-20">
          <div className="absolute inset-0 bg-black/5 blur-[100px] rounded-full" />
          ...
          >
            ...
            >
              <Activity className="w-14 h-14 text-black stroke-[1px]" />
            </motion.div>
          </motion.div>
        </div>

        <div className="flex flex-col items-center space-y-6 w-64 text-center">
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-[11px] font-black uppercase tracking-[0.8em] text-black/40 translate-x-[0.4em]"
          >
            Synchronizing Pulse
          </motion.p>
          
          <div className="w-full h-[2px] bg-black/5 relative rounded-full overflow-hidden">
             <motion.div 
               animate={{ x: ["-100%", "100%"] }}
               transition={{ repeat: Infinity, duration: 1.8, ease: [0.45, 0, 0.55, 1] }}
               className="absolute inset-y-0 w-1/3 bg-black/40"
             />
          </div>
        </div>
      </div>
